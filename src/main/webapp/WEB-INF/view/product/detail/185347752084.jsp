    ...
    <div class="col-12 col-md-6" style="padding-bottom: 40px">
     <font rwr="1" size="4" style="font-family:Arial">
      <font face="Arial" style="color: #273C2C">
       <img alt="Image" class="mx-auto d-block img-fluid" src="https://i.postimg.cc/GmvY9pKN/NUEVOS-MARCOS-2021.jpg" style="width: 90%" title="Image"/>
      </font>
     </font>
    </div>
