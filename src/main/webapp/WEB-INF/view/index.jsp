                    ...
                    <div class="login_info">
                        <div class="login_regist">
                        	<c:if test="${empty memberInfo }">
	                            <div class="login">
	                                <a href="user/login.do"><button type="button" class="btn btn-info">로그인</button></a>
	                            </div>
	                            <div class="regist">
	                                <a href="user/regist.do"><button type="button" class="btn btn-success">회원가입</button></a>
	                            </div>
	                            <br>
                        		<a href="user/searchId.do" id="find">아이디 찾기 / 비밀번호 찾기</a>
                            </c:if>
                            <c:if test="${!empty memberInfo }">
                            	<div class="login">
	                                <a href="user/logout.do"><button type="button" class="btn btn-info">로그아웃</button></a>
	                            </div>
	                            <div class="regist">
	                                <a href="user/mypage.do"><button type="button" class="btn btn-success">마이페이지</button></a>
	                            </div>
	                            <br>
                        		<a href="user/edit.do" id="find">개인정보 수정</a>
	                        </c:if>
                        </div>
                    </div>
		                        ...
		                        <c:if test="${!empty list }">    
			                        <c:forEach var="vo" items="${list}">   
				                        <ul <c:if test="${vo.note == 1 }">class="notice"</c:if>>
				                            <li class="subject" style="text-align:left;"><a href="/TProject/cs/view.do?noticeno=${vo.noticeno}">${vo.title }</a>
